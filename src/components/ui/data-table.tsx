...
function DataTable<T extends { id?: number | string }>({
    ...
    return (
        <Card className={`!p-0 overflow-hidden ${className}`}> {/* Use Card, remove padding */}
                                ...
                                {columns.map((col) => {
                                    ...
                                    return (
                                        <td
                                            ...
                                            className={`px-4 py-2 whitespace-nowrap text-sm align-middle ${col.cellClassName || 'text-gray-700'}`} // Align middle
                                        >
